...
Route::middleware('auth:api')->group(function () {
    ...
    Route::apiResource('wallets.transactions', WalletTransactionController::class)->only(['store', 'show', 'update', 'destroy']);

    // Nested index (deprecated)
    Route::get('/wallets/{wallet}/transactions', [WalletTransactionController::class, 'index'])->whereUuid('wallet');
    ...
    Route::get('/charts/net-in-month', [ChartController::class, 'netInMonth']);
});
